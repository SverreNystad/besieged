 ...
 * based on the screen dimensions. It allows for flexible UI and game object rendering across different screen sizes.
 *
 * @param screen_u The relative X-coordinate (U) of the entity on the screen, ranging from 0 (left edge) to 1 (right edge).
 * @param screen_v The relative Y-coordinate (V) of the entity on the screen, ranging from 0 (bottom edge) to 1 (top edge).
 * @param u_size The relative width of the entity on the screen, expressed as a fraction of the screen's width (0 to 1).
 * @param v_size The relative height of the entity on the screen, expressed as a fraction of the screen's height (0 to 1).
 * @param texture_path The path to the texture image file used for drawing the entity.
 * @param z_index The Z-index determines the rendering order of entities, with higher values rendered in front of lower ones.
 *
